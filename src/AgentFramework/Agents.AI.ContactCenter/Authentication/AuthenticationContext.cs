...
/// Snapshot of the caller-edge metadata (E.164, display name, server call id). May be
/// <see langword="null"/> when the orchestrator is invoked mid-call (e.g. by a PIN tool)
/// rather than at the start of the call.
/// </param>
