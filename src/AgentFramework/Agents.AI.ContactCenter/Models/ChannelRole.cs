...
namespace Agents.AI.ContactCenter.Models;
...
public enum ChannelRole
{
    ...
    /// <summary>
    /// Context consumer — subscribes to the <see cref="HubSessionEventBus"/>
    /// and injects aggregated context into an AI agent's reasoning.
    /// </summary>
    ContextSink = 1 << 5,

    /// <summary>
    /// Agent-to-Agent communication channel. Participates in the session
    /// by exchanging messages with other agents and publishing
    /// <see cref="HubSessionEventKind.AgentInsight"/> events to the context bus.
    /// </summary>
    AgentToAgent = 1 << 6
}
