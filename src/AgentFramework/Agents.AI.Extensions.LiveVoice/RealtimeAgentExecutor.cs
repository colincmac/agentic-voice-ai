...
//    private async Task<AgentSession> EnsureThreadAsync(CancellationToken cancellationToken = default) {
...
//            if(thread is not AgentSession threadSession)
//            {
//               throw new InvalidOperationException($"Deserialized thread is not of expected type {nameof(AgentSession)}");
//            }
