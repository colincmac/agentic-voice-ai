...
//internal class IvrAgent : DelegatingRealtimeAIAgent
//{
...
//    {
//        if (thread is not AgentSession conversationSessionThread) throw new ArgumentException("Invalid thread type", nameof(thread));
