...
internal sealed class FunctionInvokingRealtimeClientSession : IRealtimeClientSession
{
    ...
    private static readonly AsyncLocal<FunctionInvocationContext?> currentContext = new();
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        using Activity? activity = FunctionInvocationHelpers.CurrentActivityIsInvokeAgent ? null : _activitySource?.StartActivity(GenAI.OperationNameValues.OrchestrateToolsName);
