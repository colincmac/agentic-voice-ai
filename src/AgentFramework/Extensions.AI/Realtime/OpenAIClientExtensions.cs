...
public static class OpenAIExtensions
{
    ...
    public static RealtimeFunctionTool ToOpenAIRealtimeFunctionTool(AIFunctionDeclaration aiFunction, ChatOptions? options = null)
    {
        ...
        return new RealtimeFunctionTool(aiFunction.Name)
        {
            ...
            FunctionParameters = ToOpenAIFunctionParameters(aiFunction, strict),
        };
    }
...
#pragma warning disable OPENAI001 // OpenAIRealtimeJsonContext is marked as experimental since it relies on source-generated serializers
        var tool = JsonSerializer.Deserialize(jsonSchema, OpenAIRealtimeJsonContext.Default.ToolJson)!;
        var functionParameters = BinaryData.FromBytes(JsonSerializer.SerializeToUtf8Bytes(tool, OpenAIRealtimeJsonContext.Default.ToolJson));
...
#pragma warning disable OPENAI001 // OpenAIRealtimeJsonContext is marked as experimental since it relies on source-generated serializers
    internal static FunctionCallContent ParseCallContent(string json, string callId, string name) =>
        FunctionCallContent.CreateFromParsedArguments(json, callId, name,
            static json => JsonSerializer.Deserialize(json, OpenAIRealtimeJsonContext.Default.IDictionaryStringObject)!);
#pragma warning restore OPENAI001
...
#pragma warning disable OPENAI001 // OpenAIRealtimeJsonContext is marked as experimental since it relies on source-generated serializers
    internal static FunctionCallContent ParseCallContent(BinaryData utf8json, string callId, string name) =>
        FunctionCallContent.CreateFromParsedArguments(utf8json, callId, name,
            static utf8json => JsonSerializer.Deserialize(utf8json, OpenAIRealtimeJsonContext.Default.IDictionaryStringObject)!);
#pragma warning restore OPENAI001
...
WriteIndented = true)]
[JsonSerializable(typeof(ToolJson))]
[JsonSerializable(typeof(IDictionary<string, object?>))]
[JsonSerializable(typeof(string[]))]
[JsonSerializable(typeof(IEnumerable<string>))]
[JsonSerializable(typeof(JsonElement))]
internal sealed partial class OpenAIRealtimeJsonContext : JsonSerializerContext;
