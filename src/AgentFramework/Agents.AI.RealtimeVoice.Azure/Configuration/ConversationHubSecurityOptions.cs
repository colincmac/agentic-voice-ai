...
/// <summary>
/// Configuration options for enhanced realtime voice features
/// </summary>
public sealed class ConversationHubSecurityOptions
{
    public const string SectionName = "ConversationHubSecurity";
    ...
    /// </summary>
    public FraudDetectionOptions FraudDetection { get; set; } = new();

    /// <summary>
    /// Voice biometric options
    /// </summary>
    public VoiceBiometricOptions VoiceBiometrics { get; set; } = new();
}
