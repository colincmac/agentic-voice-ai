...
public enum ContextEventKind
{
    ...
    /// <summary>An insight produced by a modality processor (screen analysis, document analysis).</summary>
    ModalityInsight,
...
public sealed record SessionContextEvent
{
    ...
    public required ContextEventKind Kind { get; init; }
...
/// <para>
/// This bus is strictly for <em>context</em> (transcripts, chat, CRM, approvals, modality insights).
...
/// </para>
/// </summary>
public sealed class SessionContextBus : IAsyncDisposable
{
    private readonly ConcurrentDictionary<Guid, ContextSubscription> _subscriptions = new();
    ...
    /// </summary>
    public ContextSubscription Subscribe(Func<SessionContextEvent, bool>? filter = null)
    {
        ObjectDisposedException.ThrowIf(_disposed != 0, this);
        var sub = new ContextSubscription(this, filter);
...
/// <summary>
/// A single subscriber to the <see cref="SessionContextBus"/> with optional filtering.
/// </summary>
public sealed class ContextSubscription : IAsyncDisposable
{
    private readonly SessionContextBus _bus;
    private int _disposed;

    internal ContextSubscription(SessionContextBus bus, Func<SessionContextEvent, bool>? filter)
    {
        _bus = bus;
        Filter = filter;
