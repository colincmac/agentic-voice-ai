...
public static class ServiceReferenceExtensions
{
    ...
    {
        ConfigureUrisClient(builder, configureClient, configurePrimaryHttpMessageHandler, name);
        ...
        return builder.Add(new HealthCheckRegistration(
            ...
            sp =>
            {
                ...
                return CreateHealthCheck(sp, name, options);
            },
            failureStatus,
            tags,
            timeout));
    ...
    private static readonly Action<IServiceProvider, HttpClient> emptyHttpClientCallback = (_, _) => { };
    private static readonly Func<IServiceProvider, HttpMessageHandler> defaultHttpMessageHandlerCallback = _ => new HttpClientHandler();
        ...
        string registrationName)
    {
        builder.Services.AddHttpClient(registrationName)
            ...
            .ConfigurePrimaryHttpMessageHandler(configurePrimaryHttpMessageHandler ?? defaultHttpMessageHandlerCallback);
    }
}
