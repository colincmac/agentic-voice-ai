...
public static class ParameterNameConstants
{
    ...
    public const string OpenAIResourceGroupName = "openAIResourceGroupName";
    public const string OpenAIName = "openAIResource";
    public const string OpenAIChatModel = "openAIChatModel";
    public const string OpenAIChatModelVersion = "openAIChatModelVersion";
    public const string OpenAIRealtimeModel = "openAIRealtimeModel";
    public const string OpenAIRealtimeModelVersion = "openAIRealtimeModelVersion";
