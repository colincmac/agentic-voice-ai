...
public static class ChatClientExtensions
{
    ...
    public static ChatClientBuilder AddKeyedChatClient(this IHostApplicationBuilder builder, string connectionName)
    {
        ...
        var chatClientBuilder = connectionInfo.Provider switch
        {
            ...
            ClientChatProvider.AzureOpenAI => builder.AddKeyedAzureOpenAIClient(connectionName, connectionInfo),//.AddKeyedChatClient(connectionName, connectionInfo.SelectedModel),
    ...
    private static ChatClientBuilder AddKeyedAzureOpenAIClient(this IHostApplicationBuilder builder, string connectionName, ChatClientConnectionInfo connectionInfo) =>
        builder.AddKeyedAzureOpenAIClient(connectionName, settings =>
        {
            settings.Endpoint = connectionInfo.Endpoint;
            settings.Key = connectionInfo.AccessKey;
        })
