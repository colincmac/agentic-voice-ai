...
//        await using var run = await InProcessExecution.RunAsync(workflow, messages, cancellationToken: ct);
//        List<ChatMessage> result = new();
//        await foreach (WorkflowEvent evt in run.(ct).ConfigureAwait(false))
//        {
