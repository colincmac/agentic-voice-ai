...
### Teams Tenant
Required Roles:
- Global Admin role OR the Skype for Business Administrator and User Administrator roles.
Prereqs:
- Teams Phone Number
- Teams Phone License - Resource Account
Resources:
...
Resources:
- Azure Bot Service
  - Tenant Id = TenantId of the Teams
  - Client Id = ClientId of the Entra App Registration in the Teams Tenant
...
Connect-MicrosoftTeams -TenantId 47391752-1e97-4cf2-be12-8f84eace2873
Get-CsOnlineApplicationInstance -Identity ivr@M365MCP80022685.onmicrosoft.com
Set-CsOnlineApplicationInstance -Identity ivr@M365MCP80022685.onmicrosoft.com -ApplicationId 85ff2dfa-78e9-4be1-bdf6-cfb0dbd123d4 -AcsResourceId 6195fece-e9d5-44a2-abd8-7621663c2a30

Sync-CsOnlineApplicationInstance -ObjectId 85ff2dfa-78e9-4be1-bdf6-cfb0dbd123d4 -ApplicationId 85ff2dfa-78e9-4be1-bdf6-cfb0dbd123d4

# App ID is the Bot Client ID
ApplicationId = App registration Client ID & Bot Client ID. Eventually it's the app id of the Teams RA as well
ObjectId = Teams RA object ID

 New-CsOnlineApplicationInstance -UserPrincipalName ivr-agent@M365MCP80022685.onmicrosoft.com -ApplicationId 10ec1b27-38db-4fc0-a3de-cc4ec20a9661 -DisplayName "IVR Agent"

 Set-CsOnlineApplicationInstance -Identity ivr-agent@M365MCP80022685.onmicrosoft.com -ApplicationId 10ec1b27-38db-4fc0-a3de-cc4ec20a9661 -AcsResourceId 6195fece-e9d5-44a2-abd8-7621663c2a30
...
Need to add ACS permissions on the app registration

az rest --method get --url https://woodgrove-ai.unitedstates.communication.azure.com/access/teamsExtension/tenants/47391752-1e97-4cf2-be12-8f84eace2873/assignments/748a7c7c-a489-4de4-8a68-4415f1d19a9c?api-version=2025-06-30
