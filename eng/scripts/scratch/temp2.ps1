...
$azureBotServiceName = "wdg-ivr-test"

# Teams Tenant
$teamsTenantId = "47391752-1e97-4cf2-be12-8f84eace2873"

$entraAppRegistrationName = "IVR Test Identity"
...
## From here assigned the license to the resource account and phone number via the portal
